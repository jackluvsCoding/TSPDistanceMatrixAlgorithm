...
//		System.out
//				.println("[Distance]: \t" + get.convertMetersToMiles(get.getElement(jsonObject, "distance")) + " mi.");
//		System.out.println(
//				"[Duration]: \t" + get.convertSecondsToMinutes(get.getElement(jsonObject, "duration")) + " mins.");
